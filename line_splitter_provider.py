...
from .line_splitter_algorithm import LineSplitterAlgorithm


class LineSplitterProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(LineSplitterAlgorithm())
